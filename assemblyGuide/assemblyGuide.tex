...
\subsubsection{About this documentation}
...
Put 3 \diameter 2 nuts in the camera support and attach the camera using \diameter 2 x6mm screws.
...
Attach the camera to its support using \diameter 2 x6mm screws.
...
Plug the audio jack. Wires order from left to right (when power bornier is farthest right): red-black-uncolored-white
...
Plug audio jack in Odroid, then use 2 \diameter 2.5x8mm screws to attch the Odroid board. Make sure the Ethernet connector is correctly placed in front of the corresponding hole.
